...
//             maxModel = obj;
//             minModel = obj;
//             maxValue = obj.maxPrice;
//             minValue = obj.minPrice;
//         } else {
//             if (IsMax(obj.highPrice, maxModel.highPrice)) {
//                 maxModel = obj;
//             }
//             if (IsMin(obj.lowPrice, minModel.lowPrice)) {
//                 minModel = obj;
//             }
//             maxValue = MaxNumber(maxValue, obj.maxPrice);
//             minValue = MinNumber(minValue, obj.minPrice);
//         }
//    }];
//
...
//    [self.dataSource.modelDataSource.models enumerateObjectsUsingBlock:^(id<HyChartKLineModelProtocol>  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
//
//        __block NSNumber *maxPrice = obj.highPrice;
//        __block NSNumber *minPrice = obj.lowPrice;
//
//        switch (self.technicalType) {
//            case HyChartKLineTechnicalTypeSMA: {
//                [klineConfigure.smaDict enumerateKeysAndObjectsUsingBlock:^(NSNumber * _Nonnull key, UIColor * _Nonnull color, BOOL * _Nonnull stop) {
//                    maxPrice = MaxNumber(obj.priceSMA([key integerValue]), maxPrice);
//                    minPrice = MinNumber(obj.priceSMA([key integerValue]), minPrice);
//                }];
//            } break;
//            case HyChartKLineTechnicalTypeEMA: {
//                [klineConfigure.emaDict enumerateKeysAndObjectsUsingBlock:^(NSNumber * _Nonnull key, UIColor * _Nonnull color, BOOL * _Nonnull stop) {
//                    maxPrice = MaxNumber(obj.priceEMA([key integerValue]), maxPrice);
//                    minPrice = MinNumber(obj.priceEMA([key integerValue]), minPrice);
//                }];
//            } break;
//            case HyChartKLineTechnicalTypeBOLL: {
//                [klineConfigure.bollDict enumerateKeysAndObjectsUsingBlock:^(NSNumber * _Nonnull key, NSArray<UIColor *> * _Nonnull colors, BOOL * _Nonnull stop) {
//                    maxPrice = MaxNumber(obj.priceBoll([key integerValue], @"up"), maxPrice);
//                    minPrice = MinNumber(obj.priceBoll([key integerValue], @"dn"), minPrice);
//                }];
//            } break;
//            default:
//            break;
