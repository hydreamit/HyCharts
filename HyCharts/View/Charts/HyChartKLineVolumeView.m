...
//             maxModel = obj;
//             minModel = obj;
//             maxValue = obj.maxVolume;
//         } else {
//             if (IsMax(obj.volume, maxModel.volume)) {
//                 maxModel = obj;
//             }
//             if (IsMin(obj.volume, minModel.volume)) {
//                 minModel = obj;
//             }
//             maxValue = MaxNumber(maxValue, obj.maxVolume);
//         }
//    }];
//
//    self.dataSource.modelDataSource.maxValue = maxValue;
//    self.dataSource.modelDataSource.minValue = [NSDecimalNumber decimalNumberWithString:[self.yAxisNunmberFormatter stringFromNumber:@(0)]];
//    self.dataSource.modelDataSource.visibleMaxVolumeModel = maxModel;
//    self.dataSource.modelDataSource.visibleMinVolumeModel = minModel;
//}
//
...
//    [self.dataSource.modelDataSource.models enumerateObjectsUsingBlock:^(id<HyChartKLineModelProtocol>  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
//
//        __block NSNumber *maxVolume = obj.volume;
//        __block NSNumber *minVolume = [NSDecimalNumber decimalNumberWithString:[obj.volumeNunmberFormatter stringFromNumber:@(0)]];
//
//        switch (self.technicalType) {
//            case HyChartKLineTechnicalTypeSMA: {
//                [klineConfigure.smaDict enumerateKeysAndObjectsUsingBlock:^(NSNumber * _Nonnull key, UIColor * _Nonnull color, BOOL * _Nonnull stop) {
//                    maxVolume = MaxNumber(obj.volumeSMA([key integerValue]), maxVolume);
//                    minVolume = MinNumber(obj.volumeSMA([key integerValue]), minVolume);
//                }];
//            } break;
//            case HyChartKLineTechnicalTypeEMA: {
//                [klineConfigure.emaDict enumerateKeysAndObjectsUsingBlock:^(NSNumber * _Nonnull key, UIColor * _Nonnull color, BOOL * _Nonnull stop) {
//                    maxVolume = MaxNumber(obj.volumeEMA([key integerValue]), maxVolume);
//                    minVolume = MinNumber(obj.volumeEMA([key integerValue]), minVolume);
//                }];
//            } break;
//            case HyChartKLineTechnicalTypeBOLL: {
//                [klineConfigure.bollDict enumerateKeysAndObjectsUsingBlock:^(NSNumber * _Nonnull key, NSArray<UIColor *> * _Nonnull colors, BOOL * _Nonnull stop) {
//                    maxVolume = MaxNumber(obj.volumeBoll([key integerValue], @"up"), maxVolume);
//                    minVolume = MinNumber(obj.volumeBoll([key integerValue], @"dn"), minVolume);
//                }];
//            } break;
//            default:
//            break;
