...
//- (void)handleVisibleModelsWithStartIndex:(NSInteger)startIndex endIndex:(NSInteger)endIndex {
//    
//    __block NSNumber *maxValue = @(- MAXFLOAT);
//    __block NSNumber *minValue = @(MAXFLOAT);
//    id<HyChartKLineConfigureProtocol> configure =  self.dataSource.configreDataSource.configure;
//    HyChartDataDirection dataDirection =  self.dataSource.configreDataSource.configure.dataDirection;
//        
//    NSIndexSet *indexSet = [NSIndexSet indexSetWithIndexesInRange:NSMakeRange(startIndex, endIndex - startIndex + 1)];
...
//            obj.visiblePosition = self.chartWidth - (obj.position - configure.trans);
//        }
//        maxValue = MaxNumber(maxValue, obj.maxValue);
//        minValue = MinNumber(minValue, obj.minValue);
//    }];
//        
//    self.dataSource.modelDataSource.maxValue = maxValue;
//    self.dataSource.modelDataSource.minValue = minValue;
//}
//
//- (void)handleTechnicalData {
//    
...
//            case HyChartKLineAuxiliaryTypeMACD: {
//                NSArray<NSNumber *> *macdParams = configure.macdDict.allKeys.firstObject;
//                NSNumber *difValue = obj.priceDIF([macdParams.firstObject integerValue], [macdParams[1] integerValue]);
//                NSNumber *demValue = obj.priceDEM([macdParams.firstObject integerValue], [macdParams[1] integerValue], [macdParams.lastObject integerValue]);
//                NSNumber *macdValue = obj.priceMACD([macdParams.firstObject integerValue], [macdParams[1] integerValue], [macdParams.lastObject integerValue]);
//                
//                maxValue = MaxNumber(maxValue, MaxNumber(MaxNumber(difValue, demValue), macdValue));
//                minValue = MinNumber(minValue, MinNumber(MinNumber(difValue, demValue), macdValue));
//            } break;
//            case HyChartKLineAuxiliaryTypeKDJ: {
//                NSArray<NSNumber *> *kdjParams = configure.kdjDict.allKeys.firstObject;
//                NSNumber *kValue = obj.priceK([kdjParams.firstObject integerValue], [kdjParams[1] integerValue]);
//                NSNumber *dValue = obj.priceD([kdjParams.firstObject integerValue], [kdjParams[1] integerValue], [kdjParams.lastObject integerValue]);
//                NSNumber *jValue = obj.priceJ([kdjParams.firstObject integerValue], [kdjParams[1] integerValue], [kdjParams.lastObject integerValue]);
//                maxValue = MaxNumber(maxValue, MaxNumber(MaxNumber(kValue, dValue), jValue));
//                minValue = MinNumber(minValue, MinNumber(MinNumber(kValue, dValue), jValue));
//            } break;
//            case HyChartKLineAuxiliaryTypeRSI: {
//                NSNumber *rsiParams = configure.rsiDict.allKeys.firstObject;
//                NSNumber *rsiValue =  obj.priceRSI([rsiParams integerValue]);
//                maxValue = rsiValue;
//                minValue = rsiValue;
//            } break;
//            default:
